...
func (s *SuperAgent) End(ctx context.Context, callback ...func(response Response, body string, errs []error)) (Response, string, []error) {
	...
	resp, body, errs := s.EndBytes(ctx, bytesCallback...)
...
func (s *SuperAgent) EndBytes(ctx context.Context, callback ...func(response Response, body []byte, errs []error)) (Response, []byte, []error) {
	var (
		errs []error
		resp Response
		body []byte
	...
	for {
		resp, body, errs = s.getResponseBytes(ctx)
		if errs != nil {
			return nil, nil, errs
		}
...
func (s *SuperAgent) EndStruct(v interface{}, callback ...func(response Response, v interface{}, body []byte, errs []error)) (Response, []byte, []error) {
	return s.endStruct(context.Background(), v, callback...)

}

func (s *SuperAgent) EndStructWithCtx(ctx context.Context, v interface{}, callback ...func(response Response, v interface{}, body []byte, errs []error)) (Response, []byte, []error) {
	return s.endStruct(ctx, v, callback...)
}

func (s *SuperAgent) endStruct(ctx context.Context, v interface{}, callback ...func(response Response, v interface{}, body []byte, errs []error)) (Response, []byte, []error) {
	resp, body, errs := s.EndBytes(ctx)
	if errs != nil {
...
func (s *SuperAgent) getResponseBytes(ctx context.Context) (Response, []byte, []error) {
	var (
		req  *http.Request
		err  error
		resp Response
